...
bool Player::CheckSkillLearnedBySpell(uint32 spellId)
{
    ...
    // Lista de spells que devem ser ignorados na checagem (para nao dar unlearn em raciais com o Racial Swap)
...
void Player::CheckDuelDistance(time_t currTime)
{
    ...
    {
        if (!IsWithinDistInMap(obj, /*50*/ 80))
        {
    ...
    {
        if (IsWithinDistInMap(obj, /*40*/ 70))
        {
